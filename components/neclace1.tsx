...
const Neclace1 = () => {
  ...
  return (
    <section className={s.sky} >
      ...
      <button className={s.cloud_4}> </button>
      <button className={s.cloud_5}> </button>
      <button className={s.cloud_6}></button>
      <button className={s.cloud_7}></button>
      <button className={s.cloud_8}> </button>
      <button className={s.cloud_9}></button>
      ...
      <button className={s.cloud_56}></button>
      <button className={s.cloud_57}> </button>
      <button className={s.cloud_58}></button>
